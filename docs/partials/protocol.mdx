...
export const ProtocolPublishSample = ({
  ...
  return (
    ...
    >
      ...
      <TabItem value="mqtt">
        <CodeBlock>
          {`mosquitto_pub -i ${identity} --username ${identity} -P ${psk}  --host mqtt.golioth.io --port 8883 --topic ${path} -m "${escapedMqttBody}"`}
        </CodeBlock>
      </TabItem>
    </Tabs>
  );
...
export const ProtocolReadSample = ({
  ...
  return (
    ...
    >
      ...
      <TabItem value="mqtt">
        <CodeBlock>
          {`mosquitto_sub -i ${identity} --username ${identity} -P ${psk}  --host mqtt.golioth.io --port 8883 --topic ${path}`}
        </CodeBlock>
...
export const ProtocolDeleteSample = ({
  ...
  return (
    ...
    >
      ...
      <TabItem value="mqtt">
        <CodeBlock>
          {`mosquitto_pub -i ${identity} --username ${identity} -P ${psk}  --host mqtt.golioth.io --port 8883 --topic ${path} -m ""`}
        </CodeBlock>
      </TabItem>
    </Tabs>
  );
